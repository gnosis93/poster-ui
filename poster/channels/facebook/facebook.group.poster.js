...
exports.FacebookGroupPoster = void 0;
var puppeteer = require("puppeteer");
var channel_base_1 = require("../channel.base");
var config_helper_1 = require("../../helpers/config.helper");
var FacebookGroupPoster = /** @class */ (function (_super) {
    __extends(FacebookGroupPoster, _super);
    function FacebookGroupPoster(postPages, credentials, imagesToPost, content) {
    ...
    FacebookGroupPoster.prototype.getImagesToPost = function () {
        return this.imagesToPost;
    };
    FacebookGroupPoster.prototype.getCredentials = function () {
        return this.credentials;
    };
    FacebookGroupPoster.prototype.getPostPages = function () {
        return this.postPages;
    };
    FacebookGroupPoster.prototype.login = function (browser) {
    ...
    FacebookGroupPoster.prototype.run = function (onPageUploadedCallback) {
    ...
    FacebookGroupPoster.prototype.postToPages = function (browser, onPageUploadedCallback) {
        if (onPageUploadedCallback === void 0) { onPageUploadedCallback = null; }
        return __awaiter(this, void 0, void 0, function () {
            var pages, count, _i, _a, group, groupPage, inputUploadHandles, inputUploadHandle, filesToUpload, _b, filesToUpload_1, fileToUpload;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        _c.sent();
                        return [4 /*yield*/, groupPage.click('.kbf60n1y')];
                    case 5:
                        _c.sent();
                    ...
                    case 12:
                        _b++;
                        return [3 /*break*/, 10];
                    case 13: return [4 /*yield*/, this.delay(1000)];
                    case 14:
                        _c.sent();
                        return [4 /*yield*/, groupPage.click('div[aria-label="Post"]')];
                    case 15:
                        _c.sent();
    ...
    FacebookGroupPoster.prototype.lunchBrowser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var config;
            return __generator(this, function (_a) {
    ...
    return FacebookGroupPoster;
}(channel_base_1.ChannelBase));
exports.FacebookGroupPoster = FacebookGroupPoster;
//# sourceMappingURL=facebook.group.poster.js.map